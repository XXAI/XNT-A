...
$Dato="DC|3.3|BPM|".$Folio."|".$FechaHoraGeneracion."|99|".number_format($TotalPercepciones+$TotalOtrosPagos,2,'.','')."|".number_format($TotalDeducciones,2,".","")."|MXN||".number_format(($TotalPercepciones+$TotalOtrosPagos)-$TotalDeducciones,2,".","")."|N|PUE|29010||||"."\r";
	...
	$Dato="CNR|".$row_srcSQL["TipoE"]."|".$FechaPago."|".$FechaInicio."|".$FechaFinal."|".$Dias."|".($TotalPercepciones ? number_format($TotalPercepciones,2,'.','') : '')."|".number_format($TotalDeduccionesEtiqueta,2,".","")."|".number_format($TotalOtrosPagos,2,".","")."|".$row_srcSQL["CURP"]."||||09||".$Turno."|09|".$row_srcSQL["NUMCHE"]."|".$row_srcSQL["CLUES"]."|".$Puesto."||".$Periodicidad."|||||CHP"."\r";
	fwrite($fh,$Dato.PHP_EOL);
	...
	*/
    ...
    if($row_srcSQL["ISR"]){
        $Dato="NDD|002|20100|IMPUESTOS SOBRE LA RENTA|".number_format($row_srcSQL["ISR"],2,".","")."\r";
        fwrite($fh,$Dato.PHP_EOL);
	}
