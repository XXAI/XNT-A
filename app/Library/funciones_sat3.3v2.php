...
function GenerarNominaSAT($TipoNomina, $TablaName, $FechaGeneracion, $FechaInicio, $FechaFinal, $Dias, $Periodicidad, $mysqli)
{
        ...
        */
			...
			do{
				...
				if($Carpeta != $row_srcSQL["NombreNomina"])
				{
					$Carpeta = $row_srcSQL["NombreNomina"];
					$TipoNomina++;
